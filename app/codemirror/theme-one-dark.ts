/**
 * 来自https://github.com/imzbf/md-editor-v3/blob/develop/packages/MdEditor/layouts/Content/codemirror
 */
...
const chalky = '#e5c07b',
  ...
  malibu = '#e5c07b',
  sage = 'var(--color-md)', // 标题等符号
  whiskey = '#d19a66',
  violet = '#c678dd',
  darkBackground = '#21252b',
  highlightBackground = '#2c313a',
  background = 'var(--color-md-bk)',
  tooltipBackground = 'var(--color-md-bk)',
  selection = '#ceedfa33',
  cursor = '#528bff'
